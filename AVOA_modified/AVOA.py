...
def AVOA(pop_size=None, max_iter=None, lower_bound=None, upper_bound=None, variables_no=None, fobj=None):
    ...
    while current_iter < max_iter:
        ...
        print('In Iteration %d, best estimation of the global optimum is %4.4f \n ' % (current_iter, Best_vulture1_F))
