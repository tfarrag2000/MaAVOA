...
listExp=GetSubDirsFirstLevelOnly("D:\My Research Results\Many_Objectives\EngProblem1");
PF_dir1="D:\OneDrive\My Research\Many_Objectives\The Code\MaAVOA_Code\PF\PF_EngProb1_4.txt";
optimum = table2array(readtable(PF_dir1));

for dir =listExp
    disp(dir);
    for i =1:400000
      F_dir="D:\My Research Results\Many_Objectives\EngProblem1"+"\"+dir+"\"+"run_"+i+"\F_new.csv";
      if isfile(F_dir)
          pat = digitsPattern;
          onlyNumbers = extract(dir, pat) ;
          metrics_dir="D:\My Research Results\Many_Objectives\EngProblem1"+"\"+dir+"\"+"run_"+i+"\metrics.csv";
