...
% end
clear
dirPF="D:\OneDrive\My Research\02_Finished\Many_Objectives\The Code\MaAVOA_Code\PF\PlatEmo";

listExp=GetSubDirsFirstLevelOnly("C:\Many_Objectives\EngProblem1");
...
for dir =listExp
    disp(dir);
    for i =1:400000
      F_dir="c:\Many_Objectives\EngProblem1"+"\"+dir+"\"+"run_"+i+"\F_new.csv";
      if isfile(F_dir)
          pat = digitsPattern;
          onlyNumbers = extract(dir, pat) ;
          metrics_dir="C:\Many_Objectives\EngProblem1"+"\"+dir+"\"+"run_"+i+"\metrics.csv";
